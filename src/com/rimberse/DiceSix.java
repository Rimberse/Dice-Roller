...
public class DiceSix extends DrawPanel {
	private static final long serialVersionUID = -4568081695996490170L;
...
//		g.fillRect(x, y, wdR, htR);
		...
		g.setColor(Color.red);
		g.fillOval(getMiddleLeftX(wdR, wdC, x), getMiddleLeftY(htR, htC, y), wdC, htC);

		g.setColor(Color.red);
		g.fillOval(getMiddleRightX(wdR, wdC, x), getMiddleRightY(htR, htC, y), wdC, htC);
